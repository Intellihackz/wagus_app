          ...
          Container(
            ...
            child: TextButton(
              onPressed: () async {
                ...
                final isTierLounge = selectedRoom == 'Tier Lounge';
                final isAllowed =
                    tier == TierStatus.adventurer || tier == TierStatus.creator;
                ...
                if (text.isNotEmpty) {
                  ...
                  if (parsed?.action == '/upgrade') {
                    if (tier == TierStatus.adventurer) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content:
                                Text('You are already an Adventurer 🧙‍♂️')),
                      );
                      controller.clear();
                      ...
                      builder: (_) => UpgradeDialog(
                          ...
                          onSuccess: () async {
                            try {
                              ...
                              if (wallet == null) {
                                print('[UpgradeDialog] ERROR: Wallet is null');
                                return false;
                              }
                  ...
                  // Handle /send
                  if (parsed?.action == '/send' && parsed!.args.length >= 2) {
                    controller.clear();
                    FocusScope.of(context).unfocus();
                    ...
                    try {
                      ...
                      debugPrint('[ChatCommand] Failed to execute /send: $e');
                    }
                    return;
                  }
